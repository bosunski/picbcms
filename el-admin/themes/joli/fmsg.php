		...
		<form id="post-edit-form" action="" method="POST"  class="form-horizontal">
			<?=$this->msg; ?>
              ...
              <div class="panel-heading ui-draggable-handle">
                  <h2 class="panel-title"><span class="fa fa-edit"></span> Edit Front Message
									</h2>
              </div>
                      ...
                      <div class="col-md-6">
                          <div class="form-group">
                              ...
                              <div class="col-md-9 col-xs-12">
                                  <textarea class="post-content form-control" rows="3" id="pbody" autocomplete="off" name="post_tag" class="input-postcontent summernote form-control"><?=$this->fmsg; ?></textarea>
                              </div>
                          </div>
                      </div>
                  </div>
