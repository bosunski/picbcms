var home = '';
$.get('media/getHome', function(result) {
  home = result;
});
$(document).ready(function(){
    ...
    $(".gallery-item-remove").on("click",function(){
      var id = $(this).attr('id');
        $.get(home + "/el-admin/media?id="+id, function(result) {
          switch(result)  {
            case '':
            ...
            default:
            //  alert('Cannot delete this picture, you can refresh or contact admin if problem persist.');
            break;
          }
        });
    });
