<?PHP
	function __autoload($class) {
		if(file_exists(ABSPATH.'includes/'.strtolower($class).'.php')) {
		...
		} elseif(file_exists(ABSPATH.'el-includes/class/'.strtolower($class).'.php')) {
			require(ABSPATH.'includes/mods/'.strtolower($class).'.php');
		}
	}
	/**
	...
	*/
	...
	function get_referer() {
		return isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : get_option('home');
	}
	...
	*/
	...
	function get_theme_css() {
		return INSTALL_DIR.'/css/theme-default.css';
	}
	function get_theme_font() {
		return INSTALL_DIR.'/css/font.css';
	}

	function load_jquery() {
		return INSTALL_DIR.'/js/plugins/jquery/jquery.min.js';
	}

	function load_login() {
		return INSTALL_DIR.'/js/login.js';
	}
	...
	/* Creates permalink based on date, name and post type */
